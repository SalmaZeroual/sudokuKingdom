          ...
          : CustomScrollView(
              slivers: [
                ...
                SliverAppBar(
                  ...
                  actions: [
  // ✅ Bouton de génération des chapitres retiré : c'est maintenant fait
  // automatiquement par le serveur au démarrage (contenu global, pas
  // besoin d'une action de l'utilisateur).
  IconButton(
